        ...
        public void RunGame()
        {
            ...
            while (gameOver == false)
            {
                ...
                if (player1.speedBuffed == true)
                {
                    ...
                    {
                        player1.Draw();
                        player1.Update(ref gameOver, map, player1, enemy1, enemy2, healthPack1, powerBuff1, speedBuff1);
                        map.DrawFromFile();
                        enemy1.Draw();
                        enemy2.Draw();
                        healthPack1.Draw();
                ...
                player1.Update(ref gameOver, map, player1, enemy1, enemy2, healthPack1, powerBuff1, speedBuff1);
                map.Update();
                enemy1.Update(map, enemy1, enemy2, player1);
                enemy2.Update(map, enemy1, enemy2, player1);
            }
        }
    }
}
